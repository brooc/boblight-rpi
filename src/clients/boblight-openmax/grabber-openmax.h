...
#ifndef GRABBEROPENMAX
#define GRABBEROPENMAX
...
//class for grabbing with Openmax
class CGrabberOpenmax
{
  public:
	CGrabberOpenmax(void* boblight, volatile bool& stop, bool sync);
    ~CGrabberOpenmax();
