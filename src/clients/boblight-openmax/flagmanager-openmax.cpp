...
#include "flagmanager-openmax.h"
#include "config.h"
#include "util/misc.h"

using namespace std;

CFlagManagerOpenmax::CFlagManagerOpenmax()
{
...
void CFlagManagerOpenmax::ParseFlagsExtended(int& argc, char**& argv, int& c, char*& optarg) //we load our own flags here
{
	  if (c == 'i') //interval
	  {
	    bool vblank = false;
...
void CFlagManagerOpenmax::PrintHelpMessage()
{
	  cout << "Usage: boblight-Openmax [OPTION]\n";
	  cout << "\n";
	  cout << "  options:\n";
	  cout << "\n";
